...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>MetaDataAPIExamples</apexClass>
    ...
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>Account.hed__SYSTEM_AccountType__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>true</editable>
    ...
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>TestAdd1__c.PrefAddress__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>TestAdd1__c.billing_street__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <fieldLevelSecurities>
        <editable>false</editable>
        <field>Test__c.LongTextAreaField__c</field>
        <hidden>true</hidden>
    </fieldLevelSecurities>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>TestAdd1__c-TestAdd1 Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
